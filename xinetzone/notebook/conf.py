...
templates_path = [f'{ROOT}/xinetzone/notebook/_templates']
...
html_static_path = [f'{ROOT}/xinetzone/notebook/_static']
html_css_files = [
    'custom.css',
]
...
html_logo = f'{ROOT}/xinetzone/notebook/_static/images/logo.jpg'
# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = f'{ROOT}/xinetzone/notebook/_static/images/favicon.jpg'
